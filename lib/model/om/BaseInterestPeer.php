...
abstract class BaseInterestPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('IntId2', 'UseId', 'IntId', 'IntName', 'IntCategory', 'IntCreatedTime', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('intId2', 'useId', 'intId', 'intName', 'intCategory', 'intCreatedTime', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::INT_ID2, self::USE_ID, self::INT_ID, self::INT_NAME, self::INT_CATEGORY, self::INT_CREATED_TIME, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('int_id2', 'use_id', 'int_id', 'int_name', 'int_category', 'int_created_time', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('IntId2' => 0, 'UseId' => 1, 'IntId' => 2, 'IntName' => 3, 'IntCategory' => 4, 'IntCreatedTime' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('intId2' => 0, 'useId' => 1, 'intId' => 2, 'intName' => 3, 'intCategory' => 4, 'intCreatedTime' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::INT_ID2 => 0, self::USE_ID => 1, self::INT_ID => 2, self::INT_NAME => 3, self::INT_CATEGORY => 4, self::INT_CREATED_TIME => 5, self::CREATED_AT => 6, self::UPDATED_AT => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('int_id2' => 0, 'use_id' => 1, 'int_id' => 2, 'int_name' => 3, 'int_category' => 4, 'int_created_time' => 5, 'created_at' => 6, 'updated_at' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(InterestPeer::INT_ID2, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(InterestPeer::DATABASE_NAME);
			$criteria->add(InterestPeer::INT_ID2, $pks, Criteria::IN);
